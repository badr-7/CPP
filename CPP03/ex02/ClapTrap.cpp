...
/*   Updated: 2023/03/15 10:44:34 by mel-hous         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::beRepaired(unsigned int amount){
    if (this->_hitPoints > 0 && this->_energyPoints)
    {
        this->_hitPoints += amount;
        this->_energyPoints -= 1;
        std::cout<<"ClapTrap "<< this->_name<< " Repaired him self by " << amount <<" of health points, his Hit Points: "<<this->_hitPoints <<std::endl;
    }
    else
